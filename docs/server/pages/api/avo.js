...
module.exports = __webpack_require__("PeVz");
...
// CONCATENATED MODULE: ./database/db_helper.js


class db_helper_Database {
  constructor() {}
  ...
  getById(id) {
    return new Promise(async (resolve, reject) => {
      try {
        const avocade = Object.values(database_data).find(avocade => avocade.id === id);
        await randomDelay();
        resolve(avocade);
      } catch (error) {
        reject(error);
...
/* harmony default export */ var db_helper = __webpack_exports__["a"] = (db_helper_Database);
...
/* harmony import */ var _database_db_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("AAqw");
...
const allAvos = async (req, resp) => {
  ...
  const DB = new _database_db_helper__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]();
